---
title: Remote Gaming - GPU Passtrough guide with Proxmox
date: '2022-06-12'
tags: ['#proxmox', '#gpu', '#passtrough']
draft: false
summary: I explain how I have passtrough my GPU to a Windows 11 VM.
images: []
layout: PostSimple
canonicalUrl:
---

# Remote Gaming and Video Encoding on Proxmox

If you need a Windows 11 VM. [Check this guide](https://docs.technotim.live/posts/windows-11-proxmox/).
...
This tutorial is working for my config: a Nvidia 3060ti, an AMD 5600x, proxmox 7 and the the 5.13 kernel version.
